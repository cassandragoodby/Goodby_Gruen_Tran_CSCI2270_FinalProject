...
class Shopping
{
    ...
    public:
        ...
        void deleteitemfromcart(std::string userTitle, std::string userBrand);
        int countFoodNodes();
        void deleteFoodNode(std::string title, std::string brand);
        void returnitemtoinventory(std::string userTitle, std::string userBrand);
        ...
        void delete1(std::string userbrand);
        void printpath();
        Rec *head = NULL;
        Rec *tail = NULL;
    ...
    private:
        void clearShoppingCart(ShoppingNode * temp); //use this for the post-order traversal deletion of the tree
        void printFoodInventory(ShoppingNode * temp);
